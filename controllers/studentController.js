...
exports.eachStudent = async (req, res) => {
  try {
    ...
    console.log("studentUserInfo",studentUserInfo)
...
if(parentInfo == null)  return res.status(200).json({  student: studentUserInfo, parent:"Student Is yet to invite parent"});
